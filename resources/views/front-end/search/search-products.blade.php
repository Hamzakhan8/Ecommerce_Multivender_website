			...
			<div class="container-fluid">
				<div class="row">
					<div class="main_title pt-2 mt-2">
						<h2>You Searched "{{Session::get('searchedcity')}}"</h2>
					</div>
					...
					<div class="main_title pt-2 mt-2">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md" style="min-width: 250px;">
								...
								<div class="col-md">
					<button type="hidden" id="searchinput" class="btn btn-clear text-dark" disabled
					value="{{Session::get('searchedcity')}}"></button>
								</div>
							</div>
...
<script>
    $(function(){
      $('#dynamic_select').on('change', function () {
          ...
          if (id) {
            window.location.replace("http://localhost/softech/public/search/products/"+id+"/"+search);
